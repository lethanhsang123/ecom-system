package com.sanzee.ecom.system.payment.service.messaging.listener.kafka;

import com.sanzee.ecom.system.kafka.consumer.KafkaConsumer;
import com.sanzee.ecom.system.kafka.order.avro.model.PaymentOrderStatus;
...
public class PaymentKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public PaymentKafkaListener(PaymentRequestMessageListener paymentRequestMessageListener, PaymentMessagingDataMapper paymentMessagingDataMapper) {
    ...
    public void receive(@Payload List<PaymentRequestAvroModel> message,
        ...
        log.info("{} number of payment requests received with keys: {}, partitions: {} and offsets: {}", message.size(),
                keys.toString(),
                partitions.toString(),
                offsets.toString());
